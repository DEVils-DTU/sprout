    ...
    return (
        <div className='text-black h-full w-full p-4'>
            <form className='flex flex-col'>
                ...
                <input type='text' placeholder='A project to help the environment' required />
                <label>Long Description</label>
                <input type='text' placeholder='A project to help the environment' className='h-fit text-wrap' required />
